...
---
#In the interactive mode we can easily move from R to python and vice versa by changing the terminal.
The result of the code " 2+2" gives the same results in both R an python but the result is clearer and neat in python.
#As for the script mode, after opening the file called "words-noinput", it appears as"words-noinput.R" which means it is R-file.
